    ...
    <>
      <div className="space-y-3.5">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          <div className="flex items-center gap-3 p-3 bg-white border border-slate-200/80 rounded-xl shadow-xs">
          ...
          <div className="flex items-center gap-3 p-3 bg-white border border-slate-200/80 rounded-xl shadow-xs">
            <div className="h-10 w-10 rounded-lg bg-slate-100 flex items-center justify-center flex-shrink-0">
              <FiCheckSquare className="h-5 w-5 text-slate-600" />
            </div>
            <div className="min-w-0">
              <p className="text-2xl font-bold text-slate-800 leading-tight">
          ...
          <div className="flex items-center gap-3 p-3 bg-white border border-slate-200/80 rounded-xl shadow-xs">
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs text-slate-500 font-medium">Archived Sessions</p>
            </div>
          </div>
        </div>

        {/* Session Tabs */}
        <div className="flex p-1 bg-slate-100/90 rounded-lg border border-slate-200/80 w-full">
          <button
            onClick={() => setSessionTab("all")}
            className={`flex-1 px-3 py-1.5 text-xs font-semibold transition-all duration-150 rounded-md ${
              sessionTab === "all"
          ...
          <CardHeader className="px-4 py-2.5 pb-2">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <CardTitle className="text-sm font-bold text-slate-800">Filters</CardTitle>
              </div>
              <Button
                variant="default"
                size="sm"
                onClick={resetFilters}
                className="h-7 text-xs px-2.5 gap-1.5 bg-slate-800 hover:bg-slate-900 text-white font-medium"
              >
          ...
          <CardContent className="px-4 pt-1 pb-3">
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-2.5">
              <div className="space-y-1">
                <Label className="text-[11px] font-semibold text-slate-500 uppercase tracking-wider">College</Label>
                <Select
              ...
              <div className="space-y-1">
                <Label className="text-[11px] font-semibold text-slate-500 uppercase tracking-wider">Course</Label>
                <Select
              ...
              <div className="space-y-1">
                <Label className="text-[11px] font-semibold text-slate-500 uppercase tracking-wider">Domain</Label>
                <Select
              ...
              <div className="space-y-1">
                <Label className="text-[11px] font-semibold text-slate-500 uppercase tracking-wider">Trainer</Label>
                <Select
              ...
              <div className="space-y-1">
                <Label className="text-[11px] font-semibold text-slate-500 uppercase tracking-wider">Project Code</Label>
                <Select
              ...
              <div className="space-y-1">
                <Label className="text-[11px] font-semibold text-slate-500 uppercase tracking-wider">Search Topic</Label>
                <Input
        ...
        <div className="flex items-center justify-between pt-0.5">
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              className="gap-1.5 text-xs h-7.5 px-3 border-blue-200 hover:bg-blue-50 hover:text-blue-700 text-blue-700 font-semibold transition-all shadow-xs"
            >
              <RotateCcw
                className={cn(
        ...
        {/* Sessions Table */}
        <div className="border border-slate-200/80 rounded-lg overflow-hidden bg-card shadow-xs">
          <Table>
            <TableHeader>
              <TableRow className="bg-slate-50/90 hover:bg-slate-50/90">
                <TableHead className="w-[100px] text-xs font-semibold py-2 px-3">SN ID</TableHead>
                <TableHead className="text-xs font-semibold py-2 px-3">Project Code</TableHead>
                <TableHead className="text-xs font-semibold py-2 px-3">Topic / Domain</TableHead>
                <TableHead className="text-xs font-semibold py-2 px-3">College / Batch</TableHead>
                <TableHead className="text-xs font-semibold py-2 px-3">Trainer</TableHead>
                <TableHead className="text-xs font-semibold py-2 px-3">Schedule</TableHead>
                <TableHead className="text-xs font-semibold py-2 px-3">Status</TableHead>
                <TableHead className="text-right text-xs font-semibold py-2 px-3">Actions</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {loading ? (
                ...
                filteredSessions.map((session) => (
                  <TableRow key={session.id} className="hover:bg-slate-50/60 transition-colors">
                    <TableCell className="py-2.5 px-3">{renderSessionId(session.id)}</TableCell>
                    <TableCell className="text-xs font-medium py-2.5 px-3">
                      {session.projectCode || "-"}
                    </TableCell>
                    <TableCell className="py-2.5 px-3">
                      <div className="font-medium text-xs text-slate-800">{session.topic}</div>
                      <div className="text-[11px] text-muted-foreground">
                        {session.domain}
                      </div>
                    </TableCell>
                    <TableCell className="py-2.5 px-3">
                      <div className="text-xs text-slate-800">{session.collegeName}</div>
                      <div className="text-[11px] text-muted-foreground">
                        {(
                          session.batches ||
                    ...
                    <TableCell className="py-2.5 px-3">
                      {(() => {
                        ...
                        if (trainers.length > 1) {
                          return (
                            <span
                              className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[11px] font-medium bg-primary/10 text-primary cursor-default"
                        ...
                        return (
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-xs">{trainers[0]?.name || "Unassigned"}</span>
                          </div>
                        );
                      })()}
                    </TableCell>
                    <TableCell className="py-2.5 px-3">
                      <div className="text-xs text-slate-800">{session.sessionDate}</div>
                      <div className="text-[11px] text-muted-foreground">
                    ...
                    <TableCell className="py-2.5 px-3">
                      <Badge
                        ...
                        className={cn(
                          "capitalize font-medium block w-fit text-[11px] px-2 py-0.5",
      ...
      {/* Session Create / Edit / Duplicate Modal */}
      <Modal
